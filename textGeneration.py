...
class Application:
    ...
    def __init__(self):
        ...
        self.T.place(x = 180, y = 5)
        self.T.config(text = "Hand Gesture To Text Prediction", font = ("Arial", 20, "bold"))
        ...
        self.T1.config(text = "Symbol Recognized :", font = ("Arial", 20, "bold"))
        ...
        self.T2.config(text = "Word Formed :", font = ("Arial", 20, "bold"))
        ...
        self.T3.config(text = "Sentence Developed :",font = ("Arial", 20, "bold"))

        self.T4 = tk.Label(self.root)
        self.T4.place(x = 250, y = 690)
        self.T4.config(text = "Auto Suggestions :", fg = "red", font = ("Arial", 20, "bold"))
    ...
    def video_loop(self):
        ...
        if ok:
            ...
            self.panel3.config(text = self.current_symbol, font = ("Arial", 20))

            self.panel4.config(text = self.word, font = ("Arial", 20))


            self.panel5.config(text = self.str,font = ("Arial", 20))

            predicts = self.hs.suggest(self.word)
            
            if(len(predicts) > 1):

                self.bt1.config(text = predicts[0], font = ("Arial", 20))
            ...
            if(len(predicts) > 2):
                ...
                self.bt2.config(text = predicts[1], font = ("Arial", 20))
            ...
            if(len(predicts) > 3):
                ...
                self.bt3.config(text = predicts[2], font = ("Arial", 20))
